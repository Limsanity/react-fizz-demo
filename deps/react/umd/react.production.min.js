...
b){};c.useEffect=function(a,b){return h.current.useEffect(a,b)};c.useImperativeHandle=function(a,b,c){return h.current.useImperativeHandle(a,b,c)};c.useLayoutEffect=function(a,b){return h.current.useLayoutEffect(a,b)};c.useMemo=function(a,b){return h.current.useMemo(a,b)};c.useReducer=function(a,b,c){return h.current.useReducer(a,b,c)};c.useRef=function(a){return h.current.useRef(a)};c.useState=function(a){return h.current.useState(a)};c.version="17.0.3"});
})();
